...
#ifdef CLI_ROLE
uint16 gapRole_MaxConnInterval = DEFAULT_MAX_CONN_INTERVAL;
uint16 gapRole_SlaveLatency = MIN_SLAVE_LATENCY;
uint16 gapRole_TimeoutMultiplier = DEFAULT_TIMEOUT_MULTIPLIER;
uint16 gapRole_MinConnInterval = DEFAULT_MIN_CONN_INTERVAL;
#else
