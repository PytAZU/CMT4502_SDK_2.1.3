...
bStatus_t SimpleProfile_GetParameter( uint8 param, void *value )
{
  ...
  switch ( param )
  {
    ...
    case SIMPLEPROFILE_CHAR5:
       VOID osal_memcpy( value, simpleProfileChar5, ATT_GetCurrentMTUSize()-3 );  
      break; 
      
    case SIMPLEPROFILE_CHAR7:
       VOID osal_memcpy( value, simpleProfileChar7, ATT_GetCurrentMTUSize()-3 );  
      break; 
  ...
  if ( pAttr->type.len == ATT_BT_UUID_SIZE )
  {
    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR5_UUID:
            ...
            *pLen = ATT_GetCurrentMTUSize()-3;
	      
	        VOID osal_memcpy( pValue, pAttr->pValue, ATT_GetCurrentMTUSize()-3);
  ...
  if ( pAttr->type.len == ATT_BT_UUID_SIZE )
  {
    ...
    switch ( uuid )
    {
      ...
      case SIMPLEPROFILE_CHAR5_UUID:
        ...
        if ( offset == 0 )
        {
          if ( len >ATT_GetCurrentMTUSize()-3 )
          {
            status = ATT_ERR_INVALID_VALUE_SIZE;
          }
        }
	  ...
	  case SIMPLEPROFILE_CHAR6:
        ...
        if ( notfEnable & GATT_CLIENT_CFG_NOTIFY )
        {
          VOID osal_memcpy( simpleProfileChar6, value, len );
            ...
            simpleProfileChar6[ATT_GetCurrentMTUSize()-4-1]=simpleProfileChar6[0];
            simpleProfileChar6[ATT_GetCurrentMTUSize()-3-1]=simpleProfileChar6[1];
