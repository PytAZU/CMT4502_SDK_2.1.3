...
// GAP GATT Attributes
static uint8 attDeviceName[GAP_DEVICE_NAME_LEN] = "CMT+A2- -FFFFFF ";
...
//                notifyBuf[16]=LO_UINT16(connlatency);
            ...
            uint8 status= simpleProfile_Notify(SIMPLEPROFILE_CHAR6,ATT_GetCurrentMTUSize()-3,notifyBuf);
  ...
  switch( paramID )
  {
    case SIMPLEPROFILE_CHAR5:
      ...
      else if(newValue[0]==0xfc)
      {
           ...
           if(      ( newValue[1] == SYS_CLK_DLL_48M || newValue[1]==SYS_CLK_XTAL_16M || newValue[1] == SYS_CLK_DLL_64M) 
