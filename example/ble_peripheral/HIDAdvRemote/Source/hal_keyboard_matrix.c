...
void hal_keyboard_matrix_task_init( uint8 task_id )
{
    ...
    {
        user_normalKey[user_combineKey[i].Subkey0].Is_Combine_KeyFlag=TRUE;
        user_normalKey[user_combineKey[i].Subkey1].Is_Combine_KeyFlag=TRUE;
    }
