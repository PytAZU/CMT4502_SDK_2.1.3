...
extern void HidDev_Report( uint16 connHandle,uint8 id, uint8 type, uint8 len, uint8 *pData );
extern void HidDev_Close( void );
extern bStatus_t HidDev_SetParameter( uint16 connHandle,uint8 param, uint8 len, void *pValue );
