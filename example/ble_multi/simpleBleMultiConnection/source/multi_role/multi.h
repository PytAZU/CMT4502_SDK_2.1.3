...
#define ADV_ENABLE_EVT				  0x0080
#define SCAN_ENABLE_EVT				  0x0100
#define ESTABLISH_CONN_EVT			  0x0200
#define SLAVE_CONN_PARAM_UPDATE		  0x0400
#define MTU_EXCHANGE_EVT			  0x0800
#else
...
typedef enum
{
  ...
  GAPROLE_SCANING,                        //!< Currently scaning, add by CMT+        
  GAPROLE_CONNECTING,                     //!< Currently scaning, add by CMT+      
  ...
  GAPROLE_CONNECTED_SCAN,                 //!< In a connection + scan, add by CMT+  `  
