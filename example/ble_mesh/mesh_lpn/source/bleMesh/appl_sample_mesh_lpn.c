...
void UI_vendor_model_set(UCHAR state)
{
    API_RESULT retval;
    ...
    param.maun_opcode = 0x0123;
    param.value = state;
    //retval = MS_generic_onoff_set(&param);
    retval=UI_vendormodel_client_send_reliable_pdu(MS_ACCESS_VENDOR_EXAMPLE_SET_OPCODE,&param);
