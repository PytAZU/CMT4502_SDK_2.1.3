...
//    printf("blebrr_advstate = %d\r\n", blebrr_advstate);
//	printf("blebrr_scanstate = %d\r\n", blebrr_scanstate);
    osal_memory_state = osal_memory_statics();    
	printf("osal_memory_state = %x\r\n", osal_memory_state);
//	printf("blebrr_datacount = %x\r\n", blebrr_datacount);
