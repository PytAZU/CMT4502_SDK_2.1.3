...
/*
 * Copyright (C) 2017. CMOSTEKINC Ltd.
 * All rights reserved.
 */
...
#define HUMITY_COLUMN_NUM   5
#define HUMITY_VALUE_LEN   2 //4
...
extern uint8 humity_raw_value_x2[HUMITY_VALUE_LEN];
extern uint8 humity_column_w2[HUMITY_VALUE_LEN];
extern uint8 humity_raw_value_y2[HUMITY_VALUE_LEN];

extern uint8 humity_raw_value_x3[HUMITY_VALUE_LEN];
extern uint8 humity_column_w3[HUMITY_VALUE_LEN];
extern uint8 humity_raw_value_y3[HUMITY_VALUE_LEN];

extern uint8 humity_raw_value_x4[HUMITY_VALUE_LEN];
extern uint8 humity_column_w4[HUMITY_VALUE_LEN];
extern uint8 humity_raw_value_y4[HUMITY_VALUE_LEN];
...
#define SENSOR_CADENCE_NUMBER  2
