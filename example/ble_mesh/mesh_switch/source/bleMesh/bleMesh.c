...
// GAP GATT Attributes
static uint8 attDeviceName[GAP_DEVICE_NAME_LEN] = "CMOSTEK BLE Mesh";
...
//                {
//                }
//                UI_generic_onoff_set(KeyCode.key,(g_counter1_on_off++)&0x01);
//            }
//            else if(((KeyCode.key-1) & 0x03)==1)
//            {
//                UI_generic_onoff_set(KeyCode.key,(g_counter2_on_off++)&0x01);
//            }
//            else if(((KeyCode.key-1) & 0x03)==2)
//            {
//                UI_generic_onoff_set(KeyCode.key,(g_counter3_on_off++)&0x01);
//            }
