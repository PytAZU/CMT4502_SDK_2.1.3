...
#ifndef __AP_TIMER_DEMO_H__
#define __AP_TIMER_DEMO_H__
 ...
 */
extern void AP_TIMER_Demo_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Application
 */
extern uint16 AP_TIMER_Demo_ProcessEvent( uint8 task_id, uint16 events );
