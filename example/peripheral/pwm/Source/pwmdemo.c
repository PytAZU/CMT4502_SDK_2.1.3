 ...
 * LOCAL VARIABLES
 */
static uint8 PWM_TaskID;   // Task ID for internal task/event processing
...
{ 
  ...
  LO_UINT16(PWM_SERV_UUID),
  HI_UINT16(PWM_SERV_UUID),
};

// Device name attribute value
static uint8 attDeviceName[GAP_DEVICE_NAME_LEN] = "Cmt+PWM";
